        ...
        <main className="home-main">
            ...
            <div className="home-content-container">
                ...
                <ul className="home-content-description">
                    ...
                    <button className="home-content-button" onClick={() => navigate('/computers/customs')}>Starter Configuration</button>
                </ul>
            </div>
            <div className="home-content-container">
                <div className="home-content-photo">
                ...
                <ul className="home-content-description">
                    ...
                    <button className="home-content-button" onClick={() => navigate('/computers/customs')}>Mid-Tier Configuration</button>
                </ul>
            </div>
            <div className="home-content-container">
                <div className="home-content-photo">
                    ...
                    <ul className="home-content-description">
                        ...
                        <button className="home-content-button" onClick={() => navigate('/computers/customs')}>High-End Configuration</button>
                    </ul>
            </div>
            <div className="home-content-container">
                <div className="home-content-photo">
                    ...
                    <ul className="home-content-description">
                        ...
                        <button className="home-content-button" onClick={() => navigate('/computers/customs')}>Super-Tier Configuration</button>
                    </ul>
            </div>
            <div className="home-content-container">
                <div className="home-content-photo">
                    ...
                    <ul className="home-content-description">
                        ...
                        <button className="home-content-button" onClick={() => navigate('/computers/customs')}>Enthusiast Configuration</button>
                    </ul>
            </div>
        </main>
    );
